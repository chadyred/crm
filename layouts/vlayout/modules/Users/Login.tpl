		...
		<div class="container-fluid login-container">
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Connexion au CRM</h3>
		</div>
			...
			{/if}
												{if isset($smarty.request.fpError)}
													<div class="alert alert-error">
														<p>Nom d'utilisateur ou adresse mail incorrect.</p>
													</div>
												{/if}
												{if isset($smarty.request.status)}
													<div class="alert alert-success">
														<p>Un mail vous a été envoyé, veuillez vérifier vos mails.</p>
													</div>
												{/if}
												{if isset($smarty.request.statusError)}
													<div class="alert alert-error">
														<p>Le serveur de mail sortant n'est pas configuré.</p>
													</div>
												{/if}
												<div class="control-group">
													<label class="control-label" for="username"><b>Nom d'utilisateur</b></label>
													<div class="controls">
				...
				<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="forgotPassword">
														<button type="submit" class="btn btn-primary sbutton">Connexion</button>
			...
			<div class="control-group">
													<label class="control-label" for="user_name"><b>Nom d'utilisateur</b></label>
				<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="backButton">
														<input type="submit" class="btn btn-primary sbutton" value="Envoyer" name="retrievePassword">
														&nbsp;&nbsp;&nbsp;<a>Retour</a>
		</div>
	</div>
</form>
						...
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 2004-{date('Y')}&nbsp;
									...
									<a href="https://www.vtiger.com/LICENSE.txt">License</a> |
									<a href="https://www.vtiger.com/products/crm/privacy_policy.html">Confidentialité</a> </small>
							</div>
						</div>
