...
class ActivityController extends Controller
{
     ...
     */
    public function listAction(Account $account = null)
    {
    ...
    public function calendarEventAction () {
        ...
        $activities = $this->get('enigmatic_crm.manager.activity')->getAllByDate(\DateTime::createFromFormat('Y-m-d', $_GET['start']), \DateTime::createFromFormat('Y-m-d', $_GET['end']), $params, true);
